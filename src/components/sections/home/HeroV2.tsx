    ...
    <header className="absolute top-0 left-0 right-0 py-6" style={{ zIndex: 50 }}>
      <div className="max-w-[1400px] mx-auto px-8 flex items-center justify-between">
          ...
          {NAV_ITEMS.map((navItem) => (
            ...
            >
              <span
                ...
                style={{ color: "#0b0217", fontFamily: "'neue-haas-grotesk-text', sans-serif" }}
              >
                {navItem.label}
                {navItem.items && (
              ...
              {navItem.items && activeNav === navItem.label && (
                <div
                  ...
                  style={{
                    ...
                    border: "1px solid rgba(11, 2, 23, 0.08)",
                ...
                >
                  {navItem.items.map((item) => (
                    <Link
                      key={item.title}
                      href={item.href}
                      className="block px-3 py-2 rounded-lg transition-colors hover:bg-[#0b0217]/5"
                    >
                      <span
                      ...
                      {item.description && (
                        <span
                          ...
                          style={{ color: "rgba(11, 2, 23, 0.5)", fontFamily: "'neue-haas-grotesk-text', sans-serif" }}
                        >
                          {item.description}
                        </span>
                      )}
        ...
        <div className="hidden lg:flex items-center gap-3">
          <Link
            href="/demo/"
            className="px-6 py-2.5 text-[14px] font-medium tracking-[0.3px] rounded-full bg-[#0b0217] text-white hover:bg-[#1a1030] transition-colors"
          ...
          <Link
            href="/contact/"
            className="px-6 py-2.5 text-[14px] font-medium tracking-[0.3px] rounded-full border border-[#0b0217]/15 bg-white text-[#0b0217] hover:bg-gray-50 transition-colors"
            style={{ fontFamily: "'neue-haas-grotesk-text', sans-serif" }}
          >
            Contact Sales
          </Link>
...
export function HeroV2() {
  ...
  return (
    <div
      ...
      style={{
        background: "radial-gradient(ellipse at 75% 5%, rgba(198,198,198,1) 0%, rgba(255,255,255,1) 60%)",
      }}
    >
      {/* Orange radial gradient - animated right to left */}
      <div
        className="absolute pointer-events-none animate-[gradientDrift_25s_linear_infinite]"
        style={{
          width: "1432px",
          height: "1432px",
          top: "-100px",
          left: "20%",
          background: "radial-gradient(circle, rgba(249,120,6,1) 24%, rgba(255,255,255,0.1) 81%)",
          zIndex: 1,
        }}
      />

      {/* Vertical frosted panes - full width, very soft/subtle */}
      ...
      {/* White gradient overlay on left/top-left to hide panes and reveal clean background */}
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          zIndex: 3,
          background: "linear-gradient(to right, rgba(255,255,255,1) 0%, rgba(255,255,255,0.95) 20%, rgba(255,255,255,0.6) 40%, rgba(255,255,255,0) 60%)",
        }}
      />
      ...
      <div className="relative w-full max-w-[1100px] mx-auto px-8 text-center pt-32" style={{ zIndex: 10 }}>
        {/* H1 - Lora serif */}
        <h1
          className="font-medium tracking-[-5px] leading-[1.12] mb-[50px]"
          style={{
        ...
        <div ref={chatboxRef} className="relative max-w-2xl mx-auto mb-8">
          ...
          <div
            ...
            style={{ background: "rgba(11,2,23,0.1)", zIndex: 0 }}
          />
          ...
          <div className="absolute -inset-[1px] rounded-[29px] overflow-hidden" style={{ zIndex: 0 }}>
            <div
              ...
              style={{
                background: "conic-gradient(from 0deg, transparent 0%, transparent 42%, rgba(249,120,6,0.7) 48%, rgba(249,120,6,0.9) 52%, rgba(249,120,6,0.7) 58%, transparent 64%, transparent 100%)",
              }}
            />
          </div>
          <div
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="flex items-center px-6 h-[56px]">
              ...
              <button
                ...
                style={{ background: "#0b0217", color: "white" }}
                aria-label="Submit"
              >
                <ArrowUpIcon />
              </button>
            ...
            {activeRoute && (
              <div className="px-6 pb-6 text-left animate-[fadeSlideIn_0.4s_ease-out]">
                <div className="pt-5" style={{ borderTop: "1px solid rgba(11, 2, 23, 0.08)" }}>
                  <h2
                    className="text-lg md:text-xl font-semibold mb-2"
                    style={{ color: "#0b0217", fontFamily: "'neue-haas-grotesk-text', sans-serif", letterSpacing: "normal" }}
                  >
                    {activeRoute.heading}
                  </h2>
                  <p
                    className="text-sm leading-relaxed mb-5"
                    style={{ color: "rgba(11, 2, 23, 0.6)", fontFamily: "'neue-haas-grotesk-text', sans-serif" }}
                  >
                    {activeRoute.body}
                  </p>
                    ...
                    {activeRoute.buttons.map((btn) => {
                      ...
                      return (
                        <a
                          ...
                          style={
                            isExpert
                              ? { background: "#0b0217", color: "white", fontFamily: "'neue-haas-grotesk-text', sans-serif" }
                              : { background: "rgba(11, 2, 23, 0.06)", color: "#0b0217", border: "1px solid rgba(11, 2, 23, 0.1)", fontFamily: "'neue-haas-grotesk-text', sans-serif" }
                          }
                        >
                          {btn.label}
                        </a>
        ...
        <div ref={pillsRef} className="flex flex-wrap justify-center gap-2 max-w-4xl mx-auto">
          {PRIMARY_PILLS.map((pill) => (
            <button
              ...
              style={{
                background: "rgba(11, 2, 23, 0.05)",
                border: "1px solid rgba(11, 2, 23, 0.1)",
                color: "#0b0217",
                fontFamily: "'neue-haas-grotesk-text', sans-serif",
              }}
            >
          ...
          {moreOpen && MORE_PILLS.map((pill) => (
            <button
              ...
              style={{
                background: "rgba(11, 2, 23, 0.03)",
                border: "1px solid rgba(11, 2, 23, 0.08)",
                color: "rgba(11, 2, 23, 0.7)",
                fontFamily: "'neue-haas-grotesk-text', sans-serif",
              }}
            >
              {pill.label}
