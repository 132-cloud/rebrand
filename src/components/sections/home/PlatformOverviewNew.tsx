      ...
      <div className="container-site">
        <ScrollReveal>
          <div className="max-w-5xl mx-auto text-center mb-10">
            <h4 className="text-[2.5rem] md:text-[3.25rem] font-bold mb-3 leading-[1.1] tracking-[-0.02em] text-[#171216]">
              One connected platform
            </h4>
            <p className="text-neutral-500 text-lg md:text-xl mb-4">
              Technology to launch. Operations to run. Growth to scale.
            </p>
            <Link href="/platform/" className="text-[#697CB2] text-sm font-medium hover:text-[#4a5d8a] transition-colors no-underline inline-flex items-center gap-1">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {capabilities.slice(0, 2).map((cap) => (
                <Link
                  key={cap.title}
                  href={cap.href}
                  className="relative rounded-2xl bg-neutral-50 p-6 md:p-8
                    min-h-[280px] md:min-h-[340px] flex flex-col justify-between
                    hover:shadow-[0_8px_32px_-4px_rgba(0,101,255,0.12)] hover:-translate-y-0.5
                    transition-all duration-300 ease-out group overflow-hidden no-underline"
                >
                  <div className="relative z-10 flex items-start justify-between">
                    <p className="text-[#171216] text-lg md:text-xl font-medium max-w-[80%]">
                      {cap.title}
                    </p>
                    <svg className="w-5 h-5 text-neutral-400 group-hover:text-neutral-600 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all duration-300 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            >
              ...
              <div className="relative z-10 flex-shrink-0 p-6 md:p-8 pb-4 md:pb-4">
                <div>
                  <p className="text-[#171216] text-lg md:text-xl font-medium mb-3">
                    Launch intelligent digital banking
                  </p>
                  <span className="inline-flex items-center text-[#697CB2] text-sm font-medium group-hover:text-[#4a5d8a] transition-colors">
                    Try the demo
              ...
              <svg className="absolute top-6 right-6 md:top-8 md:right-8 w-5 h-5 text-neutral-400 group-hover:text-neutral-600 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all duration-300 z-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 19.5l15-15m0 0H8.25m11.25 0v11.25" />
              </svg>
            </Link>
          </div>
