...
export function ArchitectureDiagramGuide() {
  const sectionRef = useRef<HTMLElement>(null);

  return (
    <section ref={sectionRef} id="architecture-diagram" className="relative section-padding bg-[#0a0a1a] overflow-hidden">
        ...
        <ScrollReveal>
          <div className="max-w-5xl mb-12">
            <h4 className="text-[2rem] md:text-[2.15rem] mb-4 leading-tight">
              <span className="font-bold">Build on a connected platform.</span>{" "}
              <span className="font-normal text-white/60">Unify banking workflows, simplify vendor management, and connect existing systems through APIs, extensible integrations, and Nymbus MCP.</span>
            </h4>
