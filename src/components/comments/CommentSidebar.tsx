          ...
          <div className="flex items-center gap-2">
            ...
            {onTogglePins && (
              <button
                ...
                className={`w-8 h-8 flex items-center justify-center rounded-lg transition-colors ${pinsHidden ? "bg-neutral-200 text-neutral-700" : "hover:bg-neutral-100 text-neutral-400"}`}
                title={pinsHidden ? "Show pins" : "Hide pins"}
              >
