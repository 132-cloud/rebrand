...
const footerColumns = [
  {
    ...
    links: [
      ...
      { title: "Nymbus MCP", href: "/products/connect/" },
      { title: "Fraud Intelligence", href: "/products/fraud-intelligence/" },
      { title: "Levels", href: "/products/levels/" },
      { title: "Engage", href: "/products/engage/" },
    ],
  },
  {
    title: "Managed Services",
    links: [
      { title: "Contact Center", href: "/managed-services/contact-center/" },
      { title: "Onboarding", href: "/managed-services/onboarding/" },
      { title: "Servicing", href: "/managed-services/servicing/" },
      { title: "Compliance", href: "/managed-services/compliance/" },
      { title: "Fraud", href: "/managed-services/fraud/" },
      { title: "Back Office", href: "/managed-services/back-office/" },
      { title: "Business Banking Support", href: "/managed-services/business-banking/" },
  ...
  },
  {
    title: "Solutions",
    links: [
      { title: "Core replacement", href: "/solutions/core-replacement/" },
