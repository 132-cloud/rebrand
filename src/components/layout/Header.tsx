  ...
  columns: [
    {
      ...
      items: [
        ...
        { title: "Levels", description: "Incentivize and reward profitable behaviors", href: "/products/levels/" },
        { title: "Engage", description: "Nurture accounts into loyal relationships", href: "/products/engage/" },
      ],
    },
    {
