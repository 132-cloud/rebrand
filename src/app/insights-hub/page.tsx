            ...
            <div className="flex flex-col md:flex-row items-start gap-10 md:gap-16">
              ...
              <div className="flex-1">
                ...
                <Link href={featuredStory.href} className="no-underline group">
                  <h1 className="text-[2.25rem] md:text-[3rem] font-bold leading-[1.1] tracking-[-0.02em] text-[#171216] mb-4 group-hover:text-[#697CB2] transition-colors">
                ...
                <button
                  ...
                  className={`px-3 py-1.5 text-xs font-semibold rounded-full whitespace-nowrap transition-colors ${
                    activeFilter === cat
                      ...
                      : "text-neutral-500 hover:text-[#171216] hover:bg-neutral-100"
                  }`}
                >
                  {cat}
                </button>
      ...
      <section className="py-12 md:py-16">
        <div className="container-site">
          ...
          <div className="mt-14 text-center">
            <button className="px-6 py-2.5 text-sm font-semibold text-[#171216] border border-neutral-300 rounded-full hover:bg-neutral-50 transition-colors">
              Load more
            </button>
          </div>
        </div>
