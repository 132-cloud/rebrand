        ...
        <div className="container-site">
          <ScrollReveal>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div>
                <p className="text-[2.5rem] font-bold text-[#171216] mb-1 tabular-nums">6</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              {domains.map((domain) => (
                <div key={domain} className="p-5 rounded-xl border border-neutral-200 bg-white">
                  <p className="text-[#171216] text-sm font-medium">{domain}</p>
                </div>
              ))}
            </div>
          </ScrollReveal>
        ...
        <div className="container-site">
          ...
          <ScrollReveal delay={0.1}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-6 md:p-8 rounded-2xl border border-neutral-200 bg-white">
                <h4 className="text-[#171216] text-base font-bold mb-3">Auto-approve, auto-deny, or refer.</h4>
              ...
              <div className="p-6 md:p-8 rounded-2xl border border-neutral-200 bg-white">
                <h4 className="text-[#171216] text-base font-bold mb-3">Every refer, worked end to end.</h4>
